...
public class PublishTaskActivity extends BaseActivity<TaskBean> implements View.OnClickListener, DataCallBack {
    ...
    protected BaseJson onEventAsync(TaskBean argument) {
        try {
            ...
            BaseJson baseJson = taskAction.publishTaskByUser(argument);
            return baseJson;
        } catch (Exception e) {
            return null;
        }
